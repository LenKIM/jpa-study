...
import jpabook.jpashop.domain.execption.NotEnoughStockException;
...
public class OrderServiceTest {
    ...
    public void 상품주문() {
        ...
        Assert.assertEquals("주문한 상품 종류 수가 정확해야 한다.", 0, book.getStockQuantity());
    }
    ...
    public void 주문취소() throws Exception {
        ...
        assertEquals("주문이 취소된 상태는 그만큼 재고가 증가해야 한다.", 10, item.getStockQuantity());
    }
